...
public class ValidateTransformationTest extends CamelSpringTestSupport {
	...
	public void transform() throws Exception {
		...
		// (flattened)
		resultEndpoint
				.expectedBodiesReceived(jsonUnprettyPrint(readFile("src/test/resources/data/json/account.json")));

		// run test
		startEndpoint
				.sendBody(readFile("src/test/resources/data/csv/customer.csv"));
	...
	protected RouteBuilder createRouteBuilder() throws Exception {
		return new RouteBuilder() {
			public void configure() throws Exception {
				from("direct:csv2json-test-input").id("validateTransformationTest")
				.log("Exchange Entry:\n${body}")
				.split().tokenize("\n")
